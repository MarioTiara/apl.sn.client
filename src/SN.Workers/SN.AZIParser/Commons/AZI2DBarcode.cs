...
public class AZI2DBarcode : IBPOM2DBarcode
{
    ...
    public AZI2DBarcode(Serial serial, AgregationLevel level, Gtin? gtin = null, Batch? batch = null, DateOnly? expireDate = null, RegistrationStatus registrationStatus = RegistrationStatus.RegisteredExternally)
    {
        Serial = serial;
        Gtin = gtin;
        Batch = batch;
    ...
    {
        if (Level == AgregationLevel.Primary)
